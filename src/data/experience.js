...
export const workExperience = [
  ...
  {
    id: "studio-centauri",
    company: "Studio Centauri, IITK",
    logo: "/assets/logos/gamedev.png",
    url: "https://gds.sntiitk.in/",
    position: "Group Leader",
    timeline: "April 2021 - April 2022",
    type: "leadership",
    tasks: [
      "Shortlisted for the position of Group Leader of Game Development Society, IIT Kanpur also known as Studio Centauri",
      "Spearheaded a 4-member team with 25 secretaries in planning and conducting 10+ lectures and workshops on advanced topics in GameDev such as Procedural Generation, Lightning Shaders, etc.",
